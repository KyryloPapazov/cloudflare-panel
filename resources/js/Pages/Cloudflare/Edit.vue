...
<template>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white shadow-md rounded-lg p-6">
            <h1 class="text-2xl font-medium text-gray-800 mb-4">Edit Cloudflare Account</h1>
            <form @submit.prevent="submit">
                ...
                <div class="mb-4">
                    ...
                    <input v-model="form.email" type="email" id="email" class="form-input mt-1 block w-full" required />
                </div>
                <div class="mb-4">
                    <label for="api_key" class="block text-gray-700 font-medium mb-2">API Key</label>
                    <input v-model="form.api_key" type="text" id="api_key" class="form-input mt-1 block w-full" required />
                </div>
                <button type="submit" class="btn h-12">Update Account</button>
...
export default {
    ...
    setup(props) {
        ...
        function submit() {
            form.put(`/cloudflare-accounts/${props.account.id}`);
        }
